/*
  # Update sequence templates to include patient name after Hello

  1. Changes
    - Update message templates to include patient name after "Hello"
    - Maintain all other content and formatting
    - Keep existing sequence days and order

  2. Security
    - No changes to existing RLS policies
*/

-- Update existing templates with patient name after Hello
UPDATE sequence_templates
SET message_template = CASE
  WHEN sequence_order = 1 THEN 'Hello {patient_name},  
...
📞 **{clinic_name} | {clinic_phone}**'
  ...
  WHEN sequence_order = 2 THEN 'Hello {patient_name},  
...
📞 **{clinic_name} | {clinic_phone}**'
  ...
  WHEN sequence_order = 3 THEN 'Hello {patient_name},  
...
📞 **{clinic_name} | {clinic_phone}**'
  ...
  WHEN sequence_order = 4 THEN 'Hello {patient_name},  
...
📞 **{clinic_name} | {clinic_phone}**'
  ...
  WHEN sequence_order = 5 THEN 'Hello {patient_name},  
...
📞 **{clinic_name} | {clinic_phone}**'
  ...
  WHEN sequence_order = 6 THEN 'Hello {patient_name},  
...
📞 **{clinic_name} | {clinic_phone}**'
  ...
  WHEN sequence_order = 7 THEN 'Hello {patient_name},  
...
📞 **{clinic_name} | {clinic_phone}**'
  ...
  WHEN sequence_order = 8 THEN 'Hello {patient_name},  
...
📞 **{clinic_name} | {clinic_phone}**'
  ...
  WHEN sequence_order = 9 THEN 'Hello {patient_name},  
