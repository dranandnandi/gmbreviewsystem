/*
  # Add default sequence templates for diabetes awareness

  1. Changes
    - Add 9 new sequence templates for the General profile type
    - Each template includes educational content about diabetes in India
    - Templates are ordered sequentially with increasing sequence days

  2. Content
    - Templates focus on diabetes awareness, management, and healthcare in India
    - Each template includes relevant article links and clinic contact information
*/
